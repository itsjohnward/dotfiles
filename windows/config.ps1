...
foreach ($line in (Invoke-webrequest -URI "https://raw.githubusercontent.com/itsjohnward/dotfiles/master/windows/choco-programs.txt").Content -split "\n")) {
    choco install $line
}

# install vscode extensions
foreach ($line in (Invoke-webrequest -URI "https://raw.githubusercontent.com/itsjohnward/dotfiles/master/vscode/extensions.txt").Content -split "\n")) {
